...
const OrbitSystem = () => {
  const orbits = [
    { size: 100, thickness: 8, duration: 0.024 }, // Mercurio
    { size: 130, thickness: 7, duration: 0.062 }, // Venus
    { size: 160, thickness: 6, duration: 0.098 }, // Tierra
    { size: 190, thickness: 5, duration: 0.186 }, // Marte
  ...
  return (
    <div className="md:absolute md:block hidden top-1/2 -left-12">
      <div className="relative flex items-center justify-center">
        {orbits.map((orbit, index) => (
          <div
            key={index}
            className="absolute rounded-full border-primary-main opacity-50"
            style={{
              width: `${orbit.size}px`,
